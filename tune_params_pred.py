...
path_to_zarr = r'/media/brandon/Data2/Brandon/fly_immune/Lightsheet_Z1/2023_05_03-dpt-gfp_r4-gal4_uas-mcd8-mcherry_ecoli-hs-dtom_early-mid_24hrs_high_dose/larvae_2/prediction.zarr'
#mem = zarr.open(path_to_zarr, 'r')
mem_da = da.from_zarr(path_to_zarr)#[0, 1]
